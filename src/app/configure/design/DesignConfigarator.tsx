...
const DesignConfigarator = ({imageUrl, configId, imageDimentions} : DesignConfigaratorProps ) => {
  ...
  return (
    <div className='relative mt-20 grid grid-cols-3 mb-20 pb-20'>
        <div className="relative h-[73.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 
        ...
        <div className="h-[37.5rem] flex flex-col bg-white">
            <ScrollArea className='relative flex-1 overflow-auto'>
                <div aria-hidden className='absolute z-10 inset-x-0 h-12 bg-gradient-to-t from-white pointer-events-none'/>
