...
const DesignPreview = ({configuration}: {configuration: Configuration}) => {
    ...
    let totaPrice = BASE_PRICE;
    if (material === 'polycarbonate') 
        totaPrice+= PRODUCT_PRICES.material.polycarbonate
    if (finish === 'textured') 
        totaPrice +=PRODUCT_PRICES.finish.textured
    ...
    const handleCheckout = () => {
        if (user) {
            ...
            // login
            localStorage.setItem("configuration", id);
                ...
                <div>
                    <p className='font-medium text-zinc-950'> Materials</p>
                        <ol className='mt-3 text-zinc-700 list-disc list-inside'>
                            ...
                            <li>Scratch and finger print resistant</li>
                    ...
                    <div className="flow-root text-sm">
                        ...
                        {finish === 'textured'? (
                         ...
                         {material === 'polycarbonate'? (
                             <div className="flex items-center justify-between py-1 mt-2">
                               <p className='text-gray-600'>Soft polycarbonate matrial</p>
                               <p className='font-medium text-gray-900'>
